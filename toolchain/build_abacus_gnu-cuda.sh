...
cmake -B $BUILD_DIR -DCMAKE_INSTALL_PREFIX=$PREFIX \
        ...
        -DCMAKE_CXX_FLAGS="-I/usr/local/cuda/include/cccl" \
        -DCMAKE_CUDA_FLAGS="-I/usr/local/cuda/include/cccl"
#         -DENABLE_DEEPKS=1 \
#         -DTorch_DIR=$LIBTORCH \
